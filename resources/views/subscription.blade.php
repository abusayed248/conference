<x-app-layout>
    @if(@$hasSubscription && !$user->is_cancel_subscription)
    <style>
        .subscription-box {
            max-width: 350px;
            background: #f8f9fa;
    ...
    <div class="mt-5">
        <div class="d-flex justify-content-center align-items-center vh-10">
            <div class="subscription-box text-center">
                ...
                <button class="btn btn-custom mt-3" @if($user->is_cancel_subscription) disabled @endif onclick="cancelSubscription()">Cancel plan renewal</button>
            </div>
        </div>
    </div>
